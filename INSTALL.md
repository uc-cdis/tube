...
The installation steps below are packaged into two containers called [Tube](https://github.com/uc-cdis/tube/blob/master/Dockerfile) and [Spark](https://github.com/uc-cdis/gen3-spark/blob/master/Dockerfile) which are orchestrated by a docker-compose called [etl-compose](https://github.com/uc-cdis/compose-etl).
You can skip the direction below and use those tools directly.
